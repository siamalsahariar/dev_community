    ...
    <section className="listings-layout">
      <div className="registration listings-card">
        <div className="registration__content">
          <h1 className="registration__title">Welcome to DEV Community</h1>
          <p className="registration__description">
            DEV Community is a community of 1,070,372 amazing developers
          </p>
        </div>
        <div className="registration__card">
          <div className="registration-providers">
            <form className="flex w-100">
              <button
                name="button"
                type="submit"
                className="crayons-btn crayons-btn--l crayons-btn--brand-apple crayons-btn--icon-left grow-1 whitespace-nowrap"
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  role="img"
                  aria-labelledby="aczxtaycyvr6v04ynb55t5gsdb60yovm"
                  aria-hidden="true"
                  className="crayons-icon"
                >
                  <title id="aczxtaycyvr6v04ynb55t5gsdb60yovm">apple</title>
            ...
            <form className="flex w-100">
              <button
                name="button"
                type="submit"
                className="crayons-btn crayons-btn--l crayons-btn--brand-forem crayons-btn--icon-left grow-1 whitespace-nowrap"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  version="1.0"
                  ...
                  role="img"
                  aria-labelledby="arjft5nkzua1f3ngie2qxv2m4mr2s2f9"
                  aria-hidden="true"
                  className="crayons-icon"
                >
                  <title id="arjft5nkzua1f3ngie2qxv2m4mr2s2f9">forem</title>
                  <g
            ...
            <form className="flex w-100">
              <button
                name="button"
                type="submit"
                className="crayons-btn crayons-btn--l crayons-btn--brand-github crayons-btn--icon-left grow-1 whitespace-nowrap"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  ...
                  viewBox="0 0 24 24"
                  role="img"
                  aria-labelledby="a96hnrnpmyoq14msdj99uagjlo61v1id"
                  aria-hidden="true"
                  className="crayons-icon"
                >
                  <title id="a96hnrnpmyoq14msdj99uagjlo61v1id">github</title>
            ...
            <form className="flex w-100">
              <button
                name="button"
                type="submit"
                className="crayons-btn crayons-btn--l crayons-btn--brand-twitter crayons-btn--icon-left grow-1 whitespace-nowrap"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  ...
                  viewBox="0 0 24 24"
                  role="img"
                  aria-labelledby="aoeuqhml8332n2uf5rcgs1wo779muz61"
                  aria-hidden="true"
                  className="crayons-icon"
                >
                  <title id="aoeuqhml8332n2uf5rcgs1wo779muz61">twitter</title>
                  <path
